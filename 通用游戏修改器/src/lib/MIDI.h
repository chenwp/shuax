...
int main()
{
	...
	midiplay.Play(TRUE);//开始播放
	//声音大小
	for(int i=20;i<80;i++)
	{
        Sleep(10);
        midiplay.SetVolume(i);
	}
	MessageBox(0,"","",0);
}
*/
...
public:
	...
	BOOL	Create(LPVOID pSoundData, DWORD dwSize, HWND pParent = 0);
	BOOL	Create(LPCTSTR pszResID, HWND pParent = 0);
	BOOL	Create(UINT uResID, HWND pParent = 0);
...
BOOL CMIDI::Create(UINT uResID, HWND pWndParent /* = NULL */)
{
	return	Create(MAKEINTRESOURCE(uResID), pWndParent);
}


BOOL CMIDI::Create(LPCTSTR pszResID, HWND pWndParent /* = NULL */)
{
	//////////////////////////////////////////////////////////////////
	// load resource
...
BOOL CMIDI::Create(LPVOID pSoundData, DWORD dwSize, HWND pWndParent /* = NULL */)
{
